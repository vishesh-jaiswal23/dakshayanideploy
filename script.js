      ...
      <div class="floating-support" data-floating-actions>
        ...
        <aside class="quick-access-panel" role="dialog" aria-labelledby="quick-access-title" id="quick-access-panel" data-floating-menu hidden tabindex="-1" aria-hidden="true">
          ...
          <div class="quick-access-body">
            ...
            <section class="quick-access-group" aria-label="Social media">
              <h3>Connect with us</h3>
              <div class="quick-access-actions">
                <a
                  href="https://www.facebook.com/dakshayani"
                  class="quick-access-link"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Visit Dakshayani Enterprises on Facebook"
                >
                  <i class="fa-brands fa-facebook"></i>
                  <span>Facebook Updates</span>
                </a>
                <a
                  href="https://www.instagram.com/dakshayani"
                  class="quick-access-link"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Visit Dakshayani Enterprises on Instagram"
                >
